...
# @app.put(path='/worker_get_session', tags=['Pro Service session'], responses=get_login_res)
# async def worker_work_in_service_session(access_token: str,
#                                          session_id: int,
#                                          delivery: bool = False,
#                                          start_work: bool = False,
#                                          finish_work: bool = False,
#                                          in_service_work: bool = False,
#                                          db=Depends(data_b.connection)):
#     """Worker get service session to work"""
#     res = requests.get(f'{auth_url}/user_id', params={"access_token": access_token})
#     status_code = res.status_code
#     if status_code != 200:
#         return JSONResponse(content=res.json(),
